...
class Program
{
    ...
    {
        foreach (Video video in new List<Video>()
        {
            new Video("Cool Video", "Bob", 20, new List<Comment>()
            {
            ...
            new Video("Cooler Video", "Bill", 500, new List<Comment>()
            {
            ...
            new Video("Coolest Video", "Benson", 1260, new List<Comment>()
            {
